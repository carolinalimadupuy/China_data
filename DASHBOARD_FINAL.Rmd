...
Page 1: Resumen general de IED {data-navmenu="Introducción"}
===============================================================

### Resumen general de IED desde China {data-height=450}
...
p2 <- ggplot(data, aes(x = idi_2024, y = ied_china, color = bri)) +
  geom_point(size = 2.5) +
  geom_smooth(method = "lm", se = FALSE, color = "black") +
  labs(title = "IED vs IDI 2024",
       x = "Índice de Desarrollo Digital (IDI)",
       y = "IED China (mill. USD)")
...
Page 2: Modelos de Regresión {data-navmenu="Análisis Multivariado"}
===================================================================
...
p1 <- ggplot(data, aes(x = fitted(mod_ols), y = ied_china)) +
  ...
  theme_minimal() +
  labs(title = "Comparación: Valores Observados vs Predichos",
       x = "Predicción del Modelo (IED)",
       y = "IED Observada")
...
p3 <- ggplot(data, aes(x = lev, y = residuals(mod_ols))) +
  ...
  theme_minimal() +
  labs(title = "Influencia de Cada País en el Modelo",
       x = "Leverage", y = "Error")
...
Page 3: Análisis Factorial (PCA) {data-navmenu="Análisis Multivariado"}
=======================================================================
...
Page 4: Análisis de Clúster {data-navmenu="Análisis Multivariado"}
===================================================================
...
Page 5: Visualización Comparativa {data-navmenu="Análisis Multivariado"}
=======================================================================
